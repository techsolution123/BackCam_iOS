...
enum UserInputFieldType {
    ...
    var titleAttr: NSAttributedString? {
        switch self {
        case .login:
            let attStr: NSAttributedString = NSAttributedString(string: "Welcome back,\nsign in.", attributes: [.font: AppFont.avenirNextDemiBold.of(45)])
            return attStr
        case .signup:
            let attStr: NSAttributedString = NSAttributedString(string: "Hey there,\nsign up.", attributes: [.font: AppFont.avenirNextDemiBold.of(45)])
            return attStr
        case .forgotPassword:
            let attStr: NSMutableAttributedString = NSMutableAttributedString(string: "Password\nRecovery.", attributes: [.font: AppFont.avenirNextDemiBold.of(45)])

            let subAttStr: NSAttributedString = NSAttributedString(string: "\n\nPlease enter your email address and we will send you an email with further instructions to reset your password.", attributes: [.font: AppFont.avenirNextRegular.of(17)])
            attStr.append(subAttStr)
            return attStr
        case .verifyCode:
            let attStr: NSAttributedString = NSAttributedString(string: "Please enter the security code generated by your mobile authenticator app.", attributes: [.font: AppFont.avenirNextRegular.of(17)])
            return attStr
        case .resetPassword:
            let attStr: NSAttributedString = NSAttributedString(string: "Reset\nPassword.", attributes: [.font: AppFont.avenirNextDemiBold.of(45)])
            return attStr
        default:
            return nil
        }
...
class UserInputFieldModel: NSObject {
    ...
    var lineColor: UIColor {
        return isValid ? AppColorManager.shared.appPurple : AppColorManager.shared.appRed
    }
}
